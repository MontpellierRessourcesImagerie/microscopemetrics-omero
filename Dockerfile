...
COPY dist/microscopemetrics_omero-0.2.0-py3-none-any.whl .
#USER root
...
#RUN pip install microscopemetrics_omero-0.2.0-py3-none-any.whl
RUN pip install microscopemetrics-omero
